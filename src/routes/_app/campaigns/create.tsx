...
import { Send, Users, FileText, ArrowLeft, Loader2 } from 'lucide-react'
...
import { useCreateCampaignMutation } from '@/hooks/useCampaignHooks'
import { toast } from 'sonner'
import { Link } from '@tanstack/react-router'
import { Badge } from '#/components/ui/badge'

export const Route = createFileRoute('/_app/campaigns/create')({
    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-foreground font-sans">New Campaign</h1>
            <p className="text-muted-foreground font-sans">Create a targeted outreach sequence.</p>
          </div>
        </div>
        <Button
