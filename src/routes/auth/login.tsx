...
import { useLoginMutation, useGoogleLoginMutation } from '@/hooks/useAuthHooks'
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-lagoon-deep p-12 flex-col justify-between text-white">
        ...
        >
          <h1 className="text-5xl font-bold font-sans leading-tight mb-6">
            Turn Business Cards Into <span className="text-[#4fb8b2]">Digital Assets</span>
          </h1>
          <p className="text-lg text-white/80 leading-relaxed font-sans">
            Streamline your networking. Scan business cards, organize contacts, and reach out instantly with AI-powered data extraction.
          </p>
        </motion.div>
        ...
        >
          <Card className="border-border shadow-2xl shadow-primary/5 bg-card/80 backdrop-blur-xl rounded-3xl overflow-hidden">
            <CardHeader className="space-y-1 pb-6">
              ...
              <CardTitle className="text-2xl font-bold tracking-tight text-foreground font-sans">Welcome back</CardTitle>
              <CardDescription className="text-muted-foreground font-sans">
                Sign in to manage your contacts and campaigns
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="relative py-2">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground font-sans">Or continue with email</span>
                </div>
              </div>
            ...
            <CardFooter className="flex flex-col space-y-4 pb-8">
              <p className="text-sm text-center text-muted-foreground font-sans">
                ...
                <Link to="/auth/signup" className="text-[#4fb8b2] hover:text-[#328f97] font-bold transition-colors">Sign up</Link>
              </p>
            </CardFooter>
          </Card>
        </motion.div>
